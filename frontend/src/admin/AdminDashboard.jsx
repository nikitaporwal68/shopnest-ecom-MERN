        ...
        const fetchStats = async () => {
            try{
                ...
                const data = await res.json();
                    console.log(data);  // check what totalRevenue actually is
  ...
  return(
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '5px' }} >
            <img src="/1.png" alt="Logo"  style={{ height: '40px', width: '40px', borderRadius: '8px', objectFit: 'cover', filter: 'drop-shadow(0 0px 10px rgba(249, 115, 22, 0.3))' }} ></img>
        ...
        {stats ? (
            ...
            <div style={{ textAlign: 'center', margin: '50px 0', color: '#f97316' }}>Loading matrics..</div>
        )}
